print('hewlo i m good boi, my nme is HOPPIE jk jk. ')
print('the ctcher has started owo ik it is trash but Ok. OOF. ')
...
cid = 817027065005735976#dont put quotes around the channel id
